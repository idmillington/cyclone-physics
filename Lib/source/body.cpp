...
static inline void _transformInertiaTensor(Matrix3& iitWorld,
	const Quaternion& /*q*/, // TODO Unused?
...
{
	transformMatrix.data[0] = 1 - 2 * orientation.ud.sd.j * orientation.ud.sd.j -
		2 * orientation.ud.sd.k * orientation.ud.sd.k;
	transformMatrix.data[1] = 2 * orientation.ud.sd.i * orientation.ud.sd.j -
		2 * orientation.ud.sd.r * orientation.ud.sd.k;
	transformMatrix.data[2] = 2 * orientation.ud.sd.i * orientation.ud.sd.k +
		2 * orientation.ud.sd.r * orientation.ud.sd.j;
	transformMatrix.data[3] = position.x;

	transformMatrix.data[4] = 2 * orientation.ud.sd.i * orientation.ud.sd.j +
		2 * orientation.ud.sd.r * orientation.ud.sd.k;
	transformMatrix.data[5] = 1 - 2 * orientation.ud.sd.i * orientation.ud.sd.i -
		2 * orientation.ud.sd.k * orientation.ud.sd.k;
	transformMatrix.data[6] = 2 * orientation.ud.sd.j * orientation.ud.sd.k -
		2 * orientation.ud.sd.r * orientation.ud.sd.i;
	transformMatrix.data[7] = position.y;

	transformMatrix.data[8] = 2 * orientation.ud.sd.i * orientation.ud.sd.k -
		2 * orientation.ud.sd.r * orientation.ud.sd.j;
	transformMatrix.data[9] = 2 * orientation.ud.sd.j * orientation.ud.sd.k +
		2 * orientation.ud.sd.r * orientation.ud.sd.i;
	transformMatrix.data[10] = 1 - 2 * orientation.ud.sd.i * orientation.ud.sd.i -
		2 * orientation.ud.sd.j * orientation.ud.sd.j;
...
void RigidBody::setInverseInertiaTensor(const Matrix3& invInertiaTensor)
{
	_checkInverseInertiaTensor(invInertiaTensor);
	inverseInertiaTensor = invInertiaTensor;
}

void RigidBody::getInverseInertiaTensor(Matrix3* invInertiaTensor) const
{
...
void RigidBody::getInverseInertiaTensorWorld(Matrix3* invInertiaTensor) const
{
	*invInertiaTensor = inverseInertiaTensorWorld;
}
	...
	const real j, const real k)
{
	...
	orientation.ud.sd.j = j;
	orientation.ud.sd.k = k;
	orientation.normalise();
}

void RigidBody::getOrientation(Quaternion* orient) const
{
	*orient = orientation;
}
...
void RigidBody::getRotation(Vector3* rot) const
{
...
void RigidBody::setCanSleep(const bool canSlp)
{
	canSleep = canSlp;
...
void RigidBody::getLastFrameAcceleration(Vector3* accel) const
{
	*accel = lastFrameAcceleration;
}
